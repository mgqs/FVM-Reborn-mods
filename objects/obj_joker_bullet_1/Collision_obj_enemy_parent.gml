if (other.hp > 0 && row == other.grid_row && can_hit(target_type, other.target_type))
{
    if (other.hp <= damage)
    {
        ...
        {
            var inst = instance_create_depth(other.x, other.y - 20, other.depth, obj_mouse_ash_death_1);
        ...
        {
            instance_create_depth(other.x, other.y - 20, other.depth, obj_mouse_ash_death_1);
        }
