...
if (first_produce == 0)
{
    ...
    if (attack_timer == (first_produce_delay + (6 * current_flash_speed)) || attack_timer == (first_produce_delay + (10 * current_flash_speed)) || attack_timer == (first_produce_delay + (14 * current_flash_speed)))
        event_user(1);
}
